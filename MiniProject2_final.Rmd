...
For mini-project 2, our group decided to look at the transaction amount accumulated in total (accounting for money also donated in opposition) for a given party in the 2012 election cycle. We were interested in where and when the money was being contributed.
